...
jest.mock("./useReport", () => jest.fn(() => mockUseReport));
...
describe("ProjectInfo", () => {
  ...
  it("calls useReport hook with correct projectID", () => {
    render(<ProjectInfo />);
    expect(require("./useReport")).toHaveBeenCalledWith("1");
  });
  ...
  it("returns null when project is undefined", () => {
    ...
    jest.mocked(require("./useReport")).mockReturnValue(mockUseReportNoProject);
  ...
  it("handles useReport hook correctly", () => {
    ...
    expect(require("./useReport")).toHaveBeenCalled();
