import { generateReportHTML } from "./index";
...
describe("PDF Report Service", () => {
  ...
  describe("generateReportHTML", () => {
    ...
    it("includes project information", () => {
      ...
      expect(result).toContain("01/12/2023 a 02/12/2023");
    });
    ...
    it("includes task rows with correct data", () => {
      ...
      expect(result).toContain("01:00:00h");

      // Check for incomplete task (❌)
      expect(result).toContain("❌");
      expect(result).toContain("Task 2");
      expect(result).toContain("00:30:00h");

      // Check for third task
      expect(result).toContain("Task 3");
      expect(result).toContain("00:15:00h");
    });
    ...
    it("calculates total time correctly", () => {
      ...
      expect(result).toContain("01:45:00h");
    ...
    it("handles empty timings array", () => {
      ...
      expect(result).toContain("00:00:00h"); // Total time should be 0
    ...
    it("includes proper HTML structure and styling", () => {
      ...
      expect(result).toContain("--jet_black: #363636");
      expect(result).toContain("--eerie_black: #1c1c1c");
      expect(result).toContain("--night_black: #0a0a0a");
    ...
    it("includes table headers", () => {
      ...
      expect(result).toContain("<th>Finalizada</th>");
      expect(result).toContain("<th>Task</th>");
      expect(result).toContain("<th>Data</th>");
      expect(result).toContain("<th>Tempo (hh:mm:ss:)</th>");
    });
    ...
    it("handles different hourly costs", () => {
      ...
      expect(result).toContain("R$100"); // Project info
